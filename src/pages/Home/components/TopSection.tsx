...
function TopSection() {
  return (
    <section className="topContainer flex flex-col md:flex-row pt-5 px-5 md:pt-10 md:px-14 bg-dark-1 md:justify-between items-center">
      <div className="textContainer flex flex-col items-start md:mr-4 mb-10 md:mb-0">
        ...
        <h2 className="text-4xl my-6 tall:my-4 md:my-6">
          Code is not just a job,
          <br /> it's a passion.
        </h2>
        <p className="text-gray">I design and code beautiful simple things, and I love what I do.</p>
        <a
      ...
      <div className="imgContainer relative h-[380px] sm:h-[435px] w-[340px] min-w-[340px] sm:w-[390px] sm:min-w-[390px]">
        ...
        <div className="flex flex-col h-full  justify-between absolute top-0 z-10">
          <img
            src={nodejs}
            alt=""
            className="sm:w-24 sm:h-24 h-20 w-20 bg-dark-2 p-4 rounded-full object-contain shadow-lg shadow-black animate-floating"
          />
        </div>
        <div className="flex flex-col h-full  justify-between absolute top-24 right-0 z-10 ">
          <img
            src={reactjs}
            alt=""
            className="sm:w-24 sm:h-24 h-20 w-20 bg-dark-2 p-4 rounded-full object-contain shadow-lg shadow-black animate-floatingR hover:h-28 hover:w-28"
          />
        </div>
