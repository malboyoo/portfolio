...
function TopSection() {
  ...
  return (
    <section className="topContainer flex flex-col md:flex-row pt-5 px-5 md:pt-10 md:px-14 bg-dark-1 md:justify-between items-center overflow-hidden">
      ...
      <div className="imgContainer relative h-[380px] sm:h-[435px] w-[340px] min-w-[340px] sm:w-[390px] sm:min-w-[390px] animate-fromRightSlow opacity-0 translate-y-5">
        <div className="z-30 absolute imgAuthor">
          <img src={thibaut} alt="Thibaut Lefevre" className="grayscale-[0.2]" />
        </div>
